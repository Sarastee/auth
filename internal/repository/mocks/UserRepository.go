...
func (_m *UserRepository) Create(_a0 context.Context, _a1 *model.UserCreate) (int64, error) {
...
func (_m *UserRepository) Update(_a0 context.Context, _a1 *model.UserUpdate) error {
	ret := _m.Called(_a0, _a1)
