...
// Add adds `func() error` callback to globalCloser
...
// New returns new Closer, if []os.Signal is specified Closer will automatically call Close all when one of signals received from OS
